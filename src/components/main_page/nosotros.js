        ...
        return(
            <div>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <h3>Nosotros</h3>
                        <p>En diversos países los sistemas de videovigilancia con dispositivos electrónicos son
...
<p>Bcstech le ofrece el diseño y ejecución de sus proyectos de videovigilancia bajo los mejores estándares de calidad y 
funcionalidad. Podemos recomendarle soluciones y adaptarnos a su presupuesto. </p>
<p>Además de la instalación de equipos de seguridad y videovigilancia, también podemos ayudarle en la 
