    ...
    render() {
        return (
            <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <h1 style={style.title}>Bienvenido a Bcstech</h1>
                        <h3 style={style.mainText}>BCSTech es su aliado en el diseño e implementación de soluciones de seguridad para <br/>
                        su hogar o empresa. Además ejecutamos proyectos que requieren la instalación de páneles y<br />
                        calentadores solares.</h3>
                        <Divider />
                    </Grid>
                    <Grid item xs={12} lg={3}>
                        <Card>
                        <CardHeader title="Videovigilancia" style={style.title} />
                        <CardMedia style={style.media} image="../images/video_img.png" title="Videovigilancia" />
                        <CardContent>
                        <Typography component="p" style={style.paragraph}>¡Que la delincuencia no te sorprenda! Utiliza la tecnología en sistemas de seguridad que te ofrecemos para monitorear 
                            ...
                            <Typography component="p" style={style.paragraph}>Vigila en todo momento tu casa o negocio a través de Internet, 
                    ...
                    <Grid item xs={12}  lg={3}>
                    <Card>
                        <CardHeader title="Paneles Solares" style={style.title}/>
                        <CardMedia style={style.media} image="images/solar_img.png" title="Energía Solar"/>
                        <CardContent>
                        <Typography componet="p" style={style.paragraph}>La energía del sol es captada por los paneles solares y convertida para ser utilizada en tu casa, negocio o industria. 
                            Además, se generan excedentes los cuales son enviados a la red de CFE, la cual será contabilizada a tu favor a través 
                            de un medidor bi-direccional. </Typography><Typography style={style.paragraph} component="p">
                    ...
                    <Grid item xs={12}  lg={3}>
                        <Card>
                            <CardHeader title="Redes de Datos" style={style.title}/>
                        <CardMedia style={style.media} image="images/red_datos_img.png" title="Redes de datos" />
                        <CardContent><Typography component="p" style={style.paragraph}>Una red de datos es un proceso de comunicación electrónica que permite la transmisión ordenada y la recepción de datos, 
                    ...
                    <Grid item xs={12}  lg={3}>
                        <Card>
                        <CardHeader title="Redes de Telefonía y Voz" style={style.title}/>
                        <CardMedia style={style.media} image="images/red_voz_img.png" title="Redes de voz"/>
                        <CardContent>
                        <Typography component="p" style={style.paragraph}>Hoy en día, la convergencia de las comunicaciones de empresa - voz, datos y video - en una única red IP es una 
