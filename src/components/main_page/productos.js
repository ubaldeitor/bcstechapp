        ...
        return(
            <div>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <h3 style={style.contactTitle}>Nuestros Productos</h3>
                        <p style={style.textContent}>A menudo, la decisión de instalar un sistema de vigilancia suele producirse tras haber vivido una experiencia desagradable. Cuando en un comercio desaparece mercancía constantemente o la seguridad personal está amenazada por actos violentos, surge el deseo de protegerse mejor y se instala un sistema de videovigilancia.
